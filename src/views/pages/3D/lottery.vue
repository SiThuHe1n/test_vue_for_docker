<template>
    <div>
                                ...
                                <td :class="{ 'zero-amount': isAmtZero(getAmountByNumber(formatNumberWithLeadingZeros(n + 500 - 1).toString(), detail_lottery_list)) }"
                                    ...
                                    {{
                                        getAmountByNumber(formatNumberWithLeadingZeros(n +
                                            500 - 1).toString(), detail_lottery_list)
                                    }} </td>
                            </tr>
        ...
        <div v-if="!is_save_loading && !is_paste_loading" class="row gx-0 mt-2 bg-white shadow rounded "
...
btn_save.disabled = true;
    ...
    console.error('Failed to read clipboard contents: ', err);
       ...
       async  handleClipboardData(data1) {
