<template>
    <div style="background: white;">
        ...
        <div class="row gx-0">
            ...
            <div class="col-6 p-1">
                <select @change="get_telegram_message()" v-model="get_am_pm"  class=" form-control bg-warning"> 
        ...
        <div v-if="!is_save_loading && !is_read_loading" class=" gx-0 " style="margin-bottom: 0px; height:80vh;overflow-y:scroll;">
            ...
            <div class="row my-1 gx-0" style="margin-bottom:200px !important;" >
                    ...
                    <div class="row" id="tg_messages"> 
                        <div  v-for="(tg,indx) in telegram_message" class="col-12" >
                          <div class="row" @click="short_long('current_message_id_'+indx)" :id="'last_message_'+indx">
                            ...
                            <div :id="'current_message_id_'+indx" style="max-height:80px;overflow:hidden;
" class="col shadow  my-2 px-3 bg-info  py-1 rounded col">
                                <div class="row">
...
return formattedTime;
     ...
     get_telegram_message()
     {
        ...
        axios.post(this.$store.state.api_url + "get_telegram_message",
                {
                   get_date: this.get_date,
     ...
     send_message()
     {
       ...
       //    this.is_save_loading=true;
        axios.post(this.$store.state.api_url + "send_message_by_telegram",
                {
