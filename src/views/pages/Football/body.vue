    ...
    <div>
        ...
        <div class="" style="width:100%;height:50px;position:relative;">
            ...
            <div style="right:0;position:absolute;" class="py-2 px-1">
                ...
                <router-link to="/body/voucher" class="btn  mx-1" style="background:#18d166 !important;"> V</router-link>

                <router-link to="football_history_body" class="btn  mx-1" style="background:#18d166 !important;"> H </router-link>
        ...
        <div class="row gx-0 mb-1">
            ...
            <div class="col-2 p-1 d-flex align-items-center  justify-content-center">
                <router-link v-if="check_list['body']==1" to="/body" class="form-control btn" style="background:#18d166 !important;font-size:10px;">
                    ဘော်ဒီ
                </router-link>
            ...
            <div class="col-2 p-1 d-flex align-items-center  justify-content-center">
                <router-link v-if="check_list['maung']==1" to="/maung" class="form-control btn btn-light  " style="font-size:10px;" >
                မောင်း
                </router-link>
        ...
        <div v-if="!is_save_loading && !is_read_loading" class="row d-flex justify-content-center gx-0 " style="margin-bottom: 100px;">
            ...
            {{ currentDate }}    ဘော်ဒီ/ဂိုးပေါင်းပွဲစဥ်များ
            </div>
            ...
            <div class="col-12 p-2 " v-for="(cm, index) in selected_data"   >
                ...
                <div class="card">
                    <div class="card-header text-black p-1" style="min-height:100%;background:#18d166">
                        <div class="row">
                            <div class="col-3">
                                <p style="font-size:12px;" class="text-start mb-0"> {{ cm.start_time }} </p>
                            </div>
                            <div class="col-6">
                                <p class="text-center mb-0" style=" white-space: normal;"> {{ cm.league }} </p>
                            </div>
        ...
        <div v-if="!is_save_loading && !is_read_loading" class="row gx-0 mt-2 bg-white shadow rounded"
            ...
            <div @click="submit_football_match()" class="col-4 text-center bg-white"
...
dat["up_or_down"] = "";
        ...
        body_check_balance()
  {
        ...
        get_update_data()
        {
            ...
            axios.post(this.$store.state.api_url + "current_body_match",
                {
