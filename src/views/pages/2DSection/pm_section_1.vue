    ...
    <div>
        ...
        <div class="cal_height" style="width:100%;height:50px;position:relative;">
            ...
            <div style="right:0;position:absolute;" class="py-2 px-1">
                ...
                <router-link to="/voucher_pm_section_1" class="btn btn-warning mx-1"> V</router-link>
            ...
            .then(response => {
                ...
                if (response.status == 200) {
                    ...
                    let get_rate_int = setInterval(() => {
                        ...
                        let chk = this.current_am_pm_type.find(item => item.type === "pm_section_1");
